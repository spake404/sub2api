      ...
      >
        <div class="flex flex-col items-stretch justify-between gap-4 sm:flex-row sm:items-center">
          <div class="min-w-0">
            ...
            <p v-if="codexFingerprintMode === 'subagent'" class="mt-2 text-xs text-primary-600 dark:text-primary-400">
              {{ t('admin.accounts.openai.codexFingerprintSubagentDesc') }}
            </p>
            <p v-else-if="codexFingerprintMode === 'subagent_v2'" class="mt-2 text-xs text-primary-600 dark:text-primary-400">
              {{ t('admin.accounts.openai.codexFingerprintSubagentV2Desc') }}
            </p>
          </div>
          <div class="w-full flex-shrink-0 sm:w-80">
