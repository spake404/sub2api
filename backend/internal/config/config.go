...
func setDefaults() {
	...
	viper.SetDefault("gateway.openai_codex_ticket.harvest_probe_interval_seconds", 60)
	viper.SetDefault("gateway.openai_codex_ticket.harvest_cooldown_seconds", 60)
	viper.SetDefault("gateway.openai_codex_ticket.max_probes_per_round", 10)
